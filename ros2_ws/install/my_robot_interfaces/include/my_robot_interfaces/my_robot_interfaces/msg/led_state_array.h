...
#ifndef MY_ROBOT_INTERFACES__MSG__LED_STATE_ARRAY_H_
#define MY_ROBOT_INTERFACES__MSG__LED_STATE_ARRAY_H_
...
#endif  // MY_ROBOT_INTERFACES__MSG__LED_STATE_ARRAY_H_
